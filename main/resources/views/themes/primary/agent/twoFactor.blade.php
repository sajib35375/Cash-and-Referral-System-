            ...
            <div class="col-md-6">
                @if(auth()->guard('agent')->user()->ts)
                    <div class="card custom--card">
                        ...
                        <form class="verification-code-form" action="{{ route('agent.twofactor.disable') }}" method="POST">
                            <div class="card-body">
                                @csrf
                ...
                @else
                    <div class="card custom--card">
                        ...
                        <form class="verification-code-form" action="{{ route('agent.twofactor.enable') }}" method="POST">
                            <div class="card-body">
                                @csrf
                                <input type="hidden" name="key" value="{{ $secret }}">
