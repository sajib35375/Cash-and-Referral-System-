        ...
        <div class="d-flex align-items-center justify-content-center w-100">
            ...
            <div class="col-md-8 col-lg-6 col-xxl-3">
                ...
                <div class="card-body">
                    ...
                    <p class="text-center">@lang('User Login')</p>
                    ...
                    <form method="POST" action="" class="verify-gcaptcha">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a class="text-primary fw-bold" href="{{ route('user.password.request.form') }}">@lang('Forgot your password?')</a>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="text-primary fw-bold ms-2" href="{{ route('user.register') }}">@lang('Create an account')</a>
                        </div>
                    </form>
                </div>
                </div>
